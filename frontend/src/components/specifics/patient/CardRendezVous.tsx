...
export default function CardRendezVous({item, pressAnnuler, pressSupprimer}){
    return(
        <View style={styles.conre}>
            ...
            <View style={styles.cf}>
                ...
                <Text style={styles.ttrr}>{item?.fullName || 'N/A'}</Text>
            </View>
            <View style={styles.cf}>
            ...
            <View style={styles.cde}>
                <ButtonComponent
                    ...
                    style={[styles.btnt, ((item?.est_passer || item?.statut === 'annulé') && styles.hidden)]}
                >
                    <Text style={styles.txtt}>Annuler</Text>
                </ButtonComponent>
                <ButtonComponent
                    onPress={pressSupprimer}
                    style={styles.btntt}
                >
                    <Text style={styles.txttr}>Supprimer</Text>
                </ButtonComponent>
            </View>

            <Text style={[
                styles.abs, 
                item?.statut === 'annulé' && styles.red,
                item?.est_passer && styles.gray
                ]}>
                    {item?.est_passer ? 'passé' : item?.statut || 'N/A'}
            </Text>
        </View>
    )
}
