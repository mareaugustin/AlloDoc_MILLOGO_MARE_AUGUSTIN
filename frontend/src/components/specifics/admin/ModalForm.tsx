...
export default function ModalFormRdv({onRequestClose, visible, valueMotif, pressNon, pressOui, loading, onChangeText}){
                ...
                <View style={styles.btnn}>
                    ...
                    >
                        {loading ? (
                            ...
                            <Text style={styles.txtO}>Annluer le rdv</Text>
                        )}
